...
/*
 * اول آگهی‌های ثبت‌شده توسط کاربر را بررسی می‌کنیم.
 * سپس اگر پیدا نشد، سراغ آگهی‌های پیش‌فرض پروژه می‌رویم.
 */
...
if (submittedProperty) {
  const normalizedProperty: Property = {
    ...
    deposit: submittedProperty.deposit,

    rent: submittedProperty.rent,

    area: submittedProperty.area,

    bedrooms: submittedProperty.bedrooms,
    ...
    type: submittedProperty.propertyType,
    ...
    lat: submittedProperty.latitude,

    lng: submittedProperty.longitude,
...
return ( <div className="flex items-center gap-3"> <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-md bg-primary-tint-1 text-primary">
{icon} </div>
...
return ( <div className="rounded-lg border border-gray-5 bg-gray-3 p-4"> <p className="text-sm text-gray-8">
{title} </p>
